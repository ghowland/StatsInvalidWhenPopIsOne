...
5. No amount of non-local data that could be analyzed would be able to give anything but pure chance as to the location of the obstacle in relation to your car, to determine which direction is best to avoid the obstacle.  Additionally, external information has the potential to be biased through the test formulation or any frames of reference in creating the test, which are unrelated to the physical location of your car and the obstacle, in this moment in time.
